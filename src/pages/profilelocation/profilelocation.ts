...
/**
 * Generated class for the ProfilelocationPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-profilelocation',
  templateUrl: 'profilelocation.html',
})
...
changeMylocation(){
  ...
  let chdata={'id':this.id,'lat': this.LastLat1,'lng': this.LastLng1}
